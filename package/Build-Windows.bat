REM Build GUIotp Windows binary package release
...
%INSTALLDIR%\%python_env% -m pip install pyInstaller

echo Packaging GUIotp
cd %INSTALLDIR%
%python_env% -m pip install OTPpy
%python_env% -O -m PyInstaller .\package\GUIotp.spec
